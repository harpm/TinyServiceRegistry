    ...
    where TEditableVM : class, new()
{
    ...
    [HttpPost("GetAll")]
    public async Task<IResponse<GridVM<TListItem, TSearchVM>>> GetAll(GridSearchModelVM<TSearchVM> searchVM)
    {
    ...
    [HttpPost("Dictionary")]
    public async Task<IResponse> GetDictionary(GridSearchModelVM<TSearchVM> model)
    {
